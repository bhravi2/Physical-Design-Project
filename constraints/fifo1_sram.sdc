...
set_input_delay 0.1 wrst_n -clock wclk

set_output_delay 0.1 wfull -clock rclk

set_output_delay 0.1 rempty -clock rclk

set_input_delay 0.1 rin -clock wclk

set_input_delay 0.1 rrst_n -clock wclk  

set_drive 0.1 wdata_in

set_drive 0.1 winc

set_drive 0.1 wrst_n

set_drive 0.1 rin

set_drive 0.1 rrst_n
...
set_output_delay 0.1 rdata -clock rclk
 
set_clock_latency 2 wclk

set_clock_latency 2 rclk

set_clock_latency 2 wclk2x
...
set_clock_uncertainty -setup 0.5 wclk

set_clock_uncertainty -setup 0.5 rclk

set_clock_uncertainty -setup 0.5 wclk2x 
